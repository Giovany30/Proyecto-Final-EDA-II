...
void List_Cursor_front(List* list); //REVISADO_No_NecesitaCambios
void List_Cursor_back( List* list );
bool List_Cursor_next(List* list); //REVISADO_No_NecesitaCambios
bool List_Cursor_prev( List* list );
bool List_Cursor_end(List* list); //REVISADO_No_NecesitaCambios
 ...
 */
Data List_Cursor_get(List* list); //REVISADO_TalVez_NecesitaCambios
