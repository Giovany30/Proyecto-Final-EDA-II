...
//El cursor apunta al primer nodo de la lista enlazada.
...
//Avanzamos hacia adelante en la lista enlazada.
...
//Devuelve true si el siguiente elemento es NULL, devuelve false en caso contrario.
